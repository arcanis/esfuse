      ...
      {prevArticle &&
        <div className={`sm:w-1/2 sm:flex flex-col items-start`}>
          <div>
            ...
            <div>
              <Link className={`text-slate-800 font-[650] flex items-center dark:text-slate-200`} to={prevArticle.link}>
      ...
      {nextArticle &&
        <div className={`sm:w-1/2 sm:flex flex-col items-end ml-auto`}>
          <div>
            ...
            <div>
              <Link className={`text-slate-800 font-[650] flex items-center dark:text-slate-200`} to={nextArticle.link}>
