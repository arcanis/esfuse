      ...
      <div className={`flex flex-col md:flex-row items-center justify-center md:justify-between`}>
        <div className={`mb-4 md:mb-0`}>
          <div className={`shrink-0 flex flex-col md:flex-row items-center`}>
            {/* Logo */}
            <Link className={`inline-flex mb-2 md:mb-0`} to={`/`} aria-label={`Cruip`}>
        ...
        <ul className={`inline-flex space-x-2`}>
          <li>
            <a className={`flex justify-center items-center text-blue-500 hover:text-blue-600 transition duration-150 ease-in-out`} href={`#0`} aria-label={`Twitter`}>
          ...
          <li>
            <a className={`flex justify-center items-center text-blue-500 hover:text-blue-600 transition duration-150 ease-in-out`} href={`#0`} aria-label={`Github`}>
              <svg className={`w-8 h-8 fill-current`} viewBox={`0 0 32 32`} xmlns={`http://www.w3.org/2000/svg`}>
          ...
          <li>
            <a className={`flex justify-center items-center text-blue-500 hover:text-blue-600 transition duration-150 ease-in-out`} href={`#0`} aria-label={`Telegram`}>
              <svg className={`w-8 h-8 fill-current`} viewBox={`0 0 32 32`} xmlns={`http://www.w3.org/2000/svg`}>
