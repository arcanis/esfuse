...
import Illustration       from 'website/sources/template/images/hero-illustration.svg?transform=url';
...
export function Layout({route, children}: {route: any, children: React.ReactElement}) {
                ...
                <div className={`md:grow md:pl-64 lg:pr-6 xl:pr-0`}>
                  <div className={`pt-24 md:pt-28 pb-8 md:pl-6 lg:pl-12`}>
                    <article className={`flex xl:space-x-12`}>
                      ...
                      <DocumentationNav toc={route.meta.toc} />
                    </article>
                  </div>
                </div>
              </div>
